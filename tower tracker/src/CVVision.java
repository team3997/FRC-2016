...
public class CVVision {
	...
	static{ 
		...
		NetworkTable.setIPAddress("roborio-3997.local");*/
	}
...
//				replaces the ##.## with your team number
				videoCapture.open("http://10.39.97.89/mjpg/video.mjpg");
//				Example
...
//		only run for the specified time
		...
		contours.clear();
			...
			//matOriginal = Imgcodecs.imread("RealFullField/" + z + ".jpg");
...
//			pixels with an area of 400 and an aspect ration greater then 1
			for (Iterator<MatOfPoint> iterator = contours.iterator(); iterator.hasNext();) {
				...
				for(MatOfPoint mop : contours){
					...
					Imgproc.rectangle(matOriginal, rec.br(), rec.tl(), YELLOW);
			}
...
//				angle to target...would not rely on this1
...
//				drawing info on target
				...
				//System.out.println("azimuth:" + (int)azimuth);
			}
